...
- 弹幕评论系统 ：支持弹幕滚动和卡片轮播两种模式
- 卡片模式 ：展示评论者头像、昵称、评论内容、时间、属地、点赞数，支持暂停/恢复
- 滚动模式 ：评论从右向左匀速滚动，支持3档字体大小、5档速度、5档密度调节
- 交互设计 ：鼠标悬停弹幕按钮弹出浮窗选择模式，卡片模式显示预览数量
- UI升级 ：玻璃效果毛玻璃背景，随机渐变色弹幕，与播放器控制台风格统一
